...
public class Leave {
		...
		public Leave(int leaveId, Date leaveStartDate, Date leaveEndDate, int empId, int noOfDays, Date leaveAppliedOn, String leaveReason) {
		...
		public String toString() {
			return "Leave [leaveId=" + leaveId + ", leaveStartDate=" + leaveStartDate + ", leaveEndDate=" + leaveEndDate
